...
class WorkmanagerActivity : AppCompatActivity() {
    ...
    private fun setupOnclickListener() {
        ...
        val longRunningOnetimeWorkRequest: WorkRequest =
            OneTimeWorkRequestBuilder<LongRunningWorkerOneTime>()
                .setInputData(longRunningWorkerData.build())
                .setScheduleRequestedAt(10, TimeUnit.SECONDS)
                .build()

        val longRunningPeriodicWorkRequest: WorkRequest =
            PeriodicWorkRequestBuilder<LongRunningWorkerPeriodic>(
                5, TimeUnit.SECONDS
            ).build()

        //Work request Defereable

        val deferrableOnetimeWorkRequest: WorkRequest =
            OneTimeWorkRequestBuilder<DeferrableOneTimeWorker>().build()
        val deferrablePeriodicWorkRequest: WorkRequest =
            PeriodicWorkRequestBuilder<DeferrablePeriodicWorker>(5, TimeUnit.SECONDS).build()
        ...
        */
        ...
        //WorkManager.getInstance(baseContext).enqueue(longRunningOnetimeWorkRequest)
        //WorkManager.getInstance(baseContext).enqueue(longRunningPeriodicWorkRequest)

        //WorkManager.getInstance(baseContext).enqueue(deferrableOnetimeWorkRequest)
        //WorkManager.getInstance(baseContext).enqueue(deferrablePeriodicWorkRequest)

        val btnOneTimeClickListenerImplementation: View.OnClickListener = View.OnClickListener {
            WorkManager.getInstance(baseContext).enqueue(immediateWorkRequest)
        }
        ...
        val btnOneTimeLongRunningClickListener: View.OnClickListener =
            btnOneTimeLongRunningClickListenerImplementation
        val btnPeriodicLongRunningClickListener: View.OnClickListener =
            btnPeriodicLongRunningClickListenerImplementation
        ...
        val btnOneTimeDefferableClickListener: View.OnClickListener =
            BtnOneTimeDefferableClickListenerImplementation()
        val btnPeriodicDefferableClickListener: View.OnClickListener =
            BtnPeriodicDefferableClickListenerImplementation()
